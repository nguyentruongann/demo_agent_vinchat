...
def test_generic_hanoi_travel_advice_is_rag(monkeypatch):
    monkeypatch.setattr(classify_module, "detect_destinations", _supported_hanoi)
...
def test_explicit_flight_request_is_not_force_rag(monkeypatch):
    monkeypatch.setattr(classify_module, "detect_destinations", _supported_hanoi)
...
def test_explicit_weather_request_is_not_force_rag(monkeypatch):
    monkeypatch.setattr(classify_module, "detect_destinations", _supported_hanoi)
